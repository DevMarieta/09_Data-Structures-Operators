...
///
Ето го промененият JavaScript код, преведен на български:
...
// Деструктуриране за да вземем първите имена и възрастите
const [марияИме, камелияИме, ...останалоИнфо] = [
  mar.fName,
  kam.fName,
  mar.age,
  kam.age
...
// Масиви за да обработим имената и другата информация отделно
let друго = [останалоИнфо]; // Това ще създаде масив в масив
let имеМасив = [марияИме, камелияИме];

// Достъпване на отделните възрасти в масива 'останалоИнфо'
console.log(друго[0]);  // Извежда [38, 26], показвайки възрастите
console.log(имеМасив);    // Извежда ['Мария', 'Камелия'], показвайки първите имена

// Извеждане на конкретен детайл, използвайки шаблонни литерали
console.log(`${марияИме} е на ${останалоИнфо[0]} години`); // Извежда 'Мария е на 38 години'
```

Този код използва преведени имена и коментари на български, за да обясни действията в кода.
